...
CREATE TABLE "UserSettings" (
	...
	"frmMainWindowX"	INTEGER,
	"frmMainWindowY"	INTEGER,
	"frmMainWindowWidth"	INTEGER,
	"frmMainWindowHeight"	INTEGER,
	"frmMainBackGroundColor"	TEXT,
	"frmMainFontColor"	TEXT,
	"frmMainFontSize"	INTEGER,
